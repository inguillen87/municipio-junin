...
const DOMAIN_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    status: 'catalogued',
    summary: 'Historial de legajo, antigüedad, estudios, otros trabajos y fojas identificados para construir el próximo módulo de trayectoria.',
    tables: Object.freeze(['histolegajo', 'legaanti', 'legaestu', 'estudio', 'otrotrab', 'foja']),
    questions: Object.freeze([
  ...
  Object.freeze({
    ...
    status: 'operational',
    summary: 'Cálculo, conceptos, códigos de liquidación, totales e historia de cierres con 24 meses de composición financiera por dimensión.',
    tables: Object.freeze(['calculo', 'codliq', 'concepto', 'totpago', 'liquidacionlog', 'histocal', 'acumula', 'fijos']),
    questions: Object.freeze([
...
const TABLE_LABELS = Object.freeze({
  ...
  art: 'Aseguradora de riesgos', actividadart: 'Actividades ART', histolegajo: 'Historial de legajo', histocal: 'Histórico de cierres de cálculo',
