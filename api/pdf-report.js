export default async function handler(req, res) {
  ...
  // Generate lightweight HTML response formatted for instant printing/saving as PDF
...
<head>
  ...
  <style>
    ...
    body { font-family: 'Helvetica Neue', Arial, sans-serif; color: #1e293b; margin: 0; padding: 30px; background: #fff; }
