...
PERSONAS no reemplaza esa autoridad laboral. Su eventual incorporación debe
ocurrir en un pipeline auxiliar, con un manifiesto independiente y una tabla
puente versionada. La igualdad de `IDPERSONA` entre GRH y PERSONAS está prohibida
...
coincidencia— no constituye un crosswalk certificado ni habilita datos
personales. El contrato de integración está en
