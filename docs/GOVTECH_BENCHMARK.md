...
| Ingreso gobernado S25 | Experiencia publicada read-only verificada en Production sobre `2b0411a37ec6474e6988a60b26bd3d3a51da858b` / `dpl_CEDxSq4dWFYekymNzkVBpV876JfX`: seis formatos hasta 4 MiB, SHA-256 y perfil agregado siempre en cuarentena; Upload/Sheets retirados con 410. El POST privado 201 sólo fue validado localmente y no mutó Production | Falta storage privado del original, antivirus, maker-checker, prueba positiva privada remota y publicación separada |
