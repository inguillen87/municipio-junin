...
|---|---|---|
| Production · S26 (frontera publicada) | 2026-08-14 | Evaluación publicada fail-closed: no monta historial ni ejecuta requests de ingreso. Product SHA `63d455b708ffddd44a5acc9480b42d8d0c61829d`, deployment `dpl_ByHJfN26qtnsDT8dBNw9KRgMKnhS`, alias estable, build 102 módulos/53 HTML/17 superficies y release truth 31/31. Un acceso Administrador limpio fue 200 sin reintento; hubo cero 5xx/fatal y `/importar` 390/320 quedó con Ayuda en el topbar, sin intersección con el límite o la tarjeta de evaluación, overflow ni errores. Scan S26 13/13 y hotfix 4/4 sin findings; delta CSS final revisado 2/2 sin P0/P1/P2. La bandeja privada de hasta 20 receipts y el POST 201 permanecen validados localmente, sin receipts privados ni escrituras DB en Production |
