...
| [`importar.html`](../importar.html) | S25 verificado en Production para la experiencia publicada read-only (`2b0411a37ec6474e6988a60b26bd3d3a51da858b` / `dpl_CEDxSq4dWFYekymNzkVBpV876JfX`) | Una sesión privada puede declarar metadatos y obtener un receipt estructural en cuarentena; la evaluación sólo inspecciona el flujo | TENANT_ADMIN publicado tiene formulario deshabilitado y cero POST. El POST privado 201 fue validado sólo localmente y no mutó Production; no conserva el original ni publica datos |
