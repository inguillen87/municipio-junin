  ...
  return (
    <aside id="snapshotMeta" className="source-status" aria-labelledby="source-status-title">
      ...
      <dl className="source-status__facts">
        ...
        <div>
          <dt>Actualización</dt>
          <dd>Hasta la fecha indicada</dd>
        </div>
        <div>
          <dt>Contenido</dt>
          <dd>Resumen general</dd>
        </div>
      </dl>
      <details className="source-status__details">
        <summary>Ver detalles técnicos de la fuente</summary>
        <dl>
          <div><dt>Archivo</dt><dd>{source.sourceFile}</dd></div>
          <div><dt>SHA-256</dt><dd className="source-status__hash">{source.sourceHash}</dd></div>
          <div><dt>Versión del inventario</dt><dd>{source.profileSchema}</dd></div>
          <div><dt>Versión de las reglas</dt><dd>{source.semanticSchema}</dd></div>
          <div><dt>Tamaño</dt><dd>{source.sourceSize}</dd></div>
          <div><dt>Fecha de los datos</dt><dd>{source.sourceSnapshot}</dd></div>
          <div><dt>Inventario generado</dt><dd>{source.profileGeneratedAt}</dd></div>
          <div><dt>Reglas generadas</dt><dd>{source.semanticGeneratedAt}</dd></div>
        </dl>
      </details>
    </aside>
  );
