...
const TRANSLATIONS = {
  ...
  pt: {
    ...
    role_it_desc: 'Administração técnica e contratos',
    role_demo_desc: 'Visualização de demonstração sem dados reais',
    ...
    dashboard_alerts_title: 'Situações que precisam de atenção',
    dashboard_alerts_critical: 'Urgente',
    dashboard_alerts_warning: 'Atenção',
    dashboard_alerts_info: 'Informação',
    ...
    dashboard_kpi_complaints: 'Pedidos de Cidadãos',
    ...
    admin_kpi_annual_projection: 'Projeção Anual',
    ...
    ia_examples: 'Quanto gastamos este mês? · Quantos funcionários temos? · Quais contratos estão vencendo em breve?',

    wa_title: 'Alertas pelo WhatsApp',
    wa_status_active: 'Bot ativo e funcionando',
    wa_status_demo: 'Modo demonstração',
