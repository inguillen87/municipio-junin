(function installMuniNavigationDefinition(global) {
  ...
  var definition = {
    ...
    items: [
      ...
      { id: 'importar', href: 'importar.html', label: 'Ingresar una fuente', shortLabel: 'Ingresar', icon: 'upload', groupId: 'data', placement: 'group', capability: 'navigation.import', primary: true },
      ...
      { id: 'manuales', href: 'manuales.html', label: 'Ayuda y aprendizaje', shortLabel: 'Ayuda', icon: 'help', groupId: null, placement: 'footer', capability: 'navigation.help', primary: true }
    ]
  };
