...
test('valid Vercel topology passes exact clean document paths without redirects', async (t) => {
  ...
  assert.deepEqual(API_PATHS, [
    ...
    '/api/grh-employment-actions',
    '/api/grh-payroll-run-control',
    '/api/grh-fixed-concept-control',
    '/api/grh-close',
    ...
    '/api/grh-management-timeline',
    '/api/grh-employment-review',
    '/api/grh-absence-insights',
    '/api/grh-personas-linkage-readiness',
    '/api/grh-personas-review',
    '/api/grh-domain-catalog',
    '/api/grh-organization-analytics',
    '/api/grh-garden-network',
